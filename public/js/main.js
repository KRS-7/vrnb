...
/**
 * Rend cliquables une à une les div de la gestion de l'organigramme, change leur classe et affiche le pop up
 * nom et prenom
 */
window.onload = function () {
    ...
    $('.card-body').hover(function () {
        ...
        $(this).append($("<button type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#exampleModal\">\n" +
            "       Modifier \n" +
            "    </button>"));
        // Affiche un mesg dans la console au clic
        $(".boutonModifier", this).click( function (e) {
            console.log("HipittyBooBlah");
        });
        // Cache les nom et prénom dans la case
        $(".nomPrenom", this).hide();
        ...
        // Affiche les nom et prénom
        $(".nomPrenom").show();
        // Supprime le bouton
        $(".btn").remove();
        // Réaffiche la couleur de fond initiale
